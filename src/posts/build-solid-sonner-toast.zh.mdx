...
#### [Contentlayer](https://contentlayer.dev/) 与 [mdx-bundler](https://github.com/kentcdodds/mdx-bundler)

参考 Contentlayer 里 `useMDXComponent()` 和 mdx-bundler 的源码，要达到上述效果，二者都做了一下事情
